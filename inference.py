...
def get_parser():
    ...
    parser.add_argument('-o', '--old_model', action='store_true', help="Resume Old model ")
    # task related
    parser.add_argument('--text', type=str, required=True,
                        help='Filename of train label data (json)')
    parser.add_argument('--pad', default=2, type=int,
                        help='padd value at the end of each sentence')
    return parser
