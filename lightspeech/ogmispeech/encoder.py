...
from lightspeech.core.attention import MultiHeadedAttention
from lightspeech.core.embedding import PositionalEncoding
from lightspeech.core.modules import MultiLayeredSepConv1d
...
class Encoder(torch.nn.Module):
    ...
    def __init__(self, idim: int,
        ...
        # TODO : switch to string to define positional encoding, then instanciate here
        self.positional_encoder = pos_enc_class(attention_dim, positional_dropout_rate)
        self.normalize_before = normalize_before
