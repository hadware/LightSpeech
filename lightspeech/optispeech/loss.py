...
class MelLoss(torch.nn.Module):
    """
    Loss function module for mel predictions.
    Inspired by Lightspeech implem from https://github.com/rishikksh20/LightSpeech
    """

    def __init__(self, regression_loss_type: str="l1", use_masking: bool = True):
        """
        Initialize feed-forward Transformer loss module.
    ...
    def forward(
        ...
        Args:
            mel_out (LongTensor): Batch of predicted_mel (B, T_mel, odim).
            mel (LongTensor): Batch of ground truth (B, T_mel, odim).
            olens (LongTensor): Batch of the lengths of each output (B,).
